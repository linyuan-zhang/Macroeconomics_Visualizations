...
To convert the above two data series from quarterly to annual, use the following code. Or, we can just `merge` the two data series with some annual data series.
